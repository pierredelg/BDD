...
select count(*)from reception where nom_commune=ancien_nom_commune;
...
select nom_commune,count(*) from reception group by nom_commune order by count(*) desc limit 1;
